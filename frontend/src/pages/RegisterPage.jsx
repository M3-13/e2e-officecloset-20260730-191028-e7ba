  ...
  return (
    <div style={styles.page}>
      <div style={styles.card}>
        <h1 style={styles.title}>Der rote Teppich erwartet dich</h1>
        <p style={styles.subtitle}>
          Erstelle dein Konto und betrete deine glamouröse Garderobe.
        </p>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          <label style={styles.label} htmlFor="register-confirm">
